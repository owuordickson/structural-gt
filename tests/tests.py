...
Nanowires_GaussianBlur = Network('dataset/Nanowires', binarized_dir='GaussianBlur')
...
Nanowires_AdaptiveThreshold = Network('dataset/Nanowires', binarized_dir='AdaptiveThreshold')
Nanowires_AdaptiveThreshold.binarize(options=AdaptiveThreshold)


# 2. GRAPH EXTRACTION
Nanowires = Network('dataset/Nanowires', binarized_dir='GaussianBlur')
