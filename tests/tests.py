...
from src.StructuralGT.Networks.networks import Network
...
Nanowires_GaussianBlur = Network('../datasets/Nanowires', binarized_dir='GaussianBlur')
...
Nanowires_AdaptiveThreshold = Network('../datasets/Nanowires', binarized_dir='AdaptiveThreshold')
Nanowires_AdaptiveThreshold.binarize(options=AdaptiveThreshold)


# 2. GRAPH EXTRACTION
Nanowires = Network('../datasets/Nanowires', binarized_dir='GaussianBlur')
...
# 3. GRAPH ANALYSIS
Nanowires = Network.from_gsd('../datasets/Nanowires/GaussianBlur/network.gsd')
