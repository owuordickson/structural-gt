...
class MainWindow(QObject):
    def __init__(self):
        ...
        self.ui_engine.rootContext().setContextProperty("imgListModel", controller.imgListModel)
        # self.ui_engine.rootContext().setContextProperty("gteListModel", controller.gteListModel)
