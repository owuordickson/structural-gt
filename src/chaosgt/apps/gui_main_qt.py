...
class Ui_window_main(object):
    def setupUi(self, window_main):
        ...
        self.grid_layout_tasks.addItem(spacerItem1, 7, 0, 1, 1)
        ...
        self.grid_layout_tasks.addItem(spacerItem2, 9, 0, 1, 1)
        ...
        self.cbx_lapacian = QtWidgets.QCheckBox(parent=self.grp_img_filters)
        self.cbx_lapacian.setObjectName("cbx_lapacian")
        self.grid_layout_filters.addWidget(self.cbx_lapacian, 4, 0, 1, 1)
        ...
        self.rdo_otsu_theshold = QtWidgets.QRadioButton(parent=self.grp_img_binary)
        self.rdo_otsu_theshold.setObjectName("rdo_otsu_theshold")
        self.btn_grp_binary = QtWidgets.QButtonGroup(window_main)
        self.btn_grp_binary.setObjectName("btn_grp_binary")
        self.btn_grp_binary.addButton(self.rdo_otsu_theshold)
        self.grid_layout_binary.addWidget(self.rdo_otsu_theshold, 3, 0, 1, 1)
        ...
        self.rdo_adaptive_theshold = QtWidgets.QRadioButton(parent=self.grp_img_binary)
        self.rdo_adaptive_theshold.setObjectName("rdo_adaptive_theshold")
        self.btn_grp_binary.addButton(self.rdo_adaptive_theshold)
        self.grid_layout_binary.addWidget(self.rdo_adaptive_theshold, 2, 0, 1, 1)
        self.rdo_global_theshold = QtWidgets.QRadioButton(parent=self.grp_img_binary)
        self.rdo_global_theshold.setChecked(True)
        self.rdo_global_theshold.setObjectName("rdo_global_theshold")
        self.btn_grp_binary.addButton(self.rdo_global_theshold)
        self.grid_layout_binary.addWidget(self.rdo_global_theshold, 1, 0, 1, 1)
    ...
    def retranslateUi(self, window_main):
        ...
        self.cbx_lapacian.setText(_translate("window_main", "Laplacian"))
        ...
        self.rdo_otsu_theshold.setText(_translate("window_main", "OTSU"))
        self.rdo_adaptive_theshold.setText(_translate("window_main", "Adaptive"))
        self.rdo_global_theshold.setText(_translate("window_main", "Global"))
