...
QtObject {
    ...
    readonly property color veryLightGray: themeManager.is_dark ? "#555" : "#e5e5e5"  // navigation background color
    readonly property color lightGray:     themeManager.is_dark ? "#333" : "#d0d0d0"  // border color
    readonly property color darkGray:       themeManager.is_dark ? "#606060" : "#303030"  // text color
    readonly property color green:    themeManager.is_dark ? "#22ff55" : "#22bc55"    // success color
    readonly property color smokeWhite:       themeManager.is_dark ? "#f5f5f5" : "#f5f5f5"  // Table rows color
